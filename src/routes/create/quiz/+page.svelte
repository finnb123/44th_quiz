					...
					<tbody class="text-xl text-headline">
						{#each loaded as { content, image_url, id }}
							...
							>
								<th
									scope="row"
									class="px-4 py-4 first-letter:font-mediumext-headline whitespace-nowrap">{id}</th
								>
								<td
									><input
										class="text-headline text-xl"
										type="checkbox"
										value={id}
										name="questions"
									/></td
								>
								<!--This is the checkbox for selecting the question -->
